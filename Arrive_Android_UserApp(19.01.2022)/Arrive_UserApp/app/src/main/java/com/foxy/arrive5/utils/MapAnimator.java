...
public class MapAnimator {
    ...
    static final int BLUE = Color.parseColor("#FAA41D");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(BLUE).width(15);
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), GREY, BLUE);
        ...
        foregroundRouteAnimator.addListener(new Animator.AnimatorListener() {
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                if (foregroundPolyline.getPoints() != null)
