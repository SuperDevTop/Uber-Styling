...
public class AutoCompleteParser1 extends AsyncTask<Void, Integer, Void> implements AdapterView.OnItemClickListener {
    ...
    public AutoCompleteParser1(Context context, LinearLayout linearLayout, TextView textView, String url, ArrayList<String> arrayListResults, ArrayAdapter<String> adapter, AutoCompleteTextView cityAutocompleteTv, Handler handler) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        textView.setText(arrayListResults.get(position));
