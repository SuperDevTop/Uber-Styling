...
class DropOffVC: UIViewController, CLLocationManagerDelegate {
    ...
    var DropOffCoord : String = ""
    let appDelegate = UIApplication.shared.delegate as! AppDelegate
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.DropOffCoord = self.appDelegate.userInfo["gcm.notification.end_point"] as! String
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.btnDropOff.layer.cornerRadius = self.btnDropOff.frame.height/2
        self.btnDropOff.layer.masksToBounds = true
        self.lblDropUpLocation.text = self.appDelegate.userInfo["gcm.notification.end_point"] as? String
    }
    ...
    @IBAction func btnDropOffAction(_ sender: UIButton) {
    ...
    func ConfirmPopScreen(){
        ...
        ConfirmArrivalVC.pathValue = "DropOffClient"
    ...
    func PickUpCoord(){
        ...
        geoCoder.geocodeAddressString(self.DropOffCoord, completionHandler: {(placemarks, error) -> Void in
            if((error) != nil){
                print("Error", error ?? "")
            }
