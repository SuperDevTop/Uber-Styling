...
public class ReviewsAdapter extends RecyclerView.Adapter<ReviewsAdapter.ViewHolder> {
    ...
    public ReviewsAdapter(Context context, List<ReviewsList> reviewsList) {
    ...
    public void onBindViewHolder(final ReviewsAdapter.ViewHolder holder, int position) {
        ReviewsList issues = reviewsList.get(position);
      ...
      //  Log.e("rghjdrghjdfger",issues.getCommentList().toString());
