        ...
        <header class="mgb">
            ...
            <div class="tbl">
                <div class="tbl-row">
                    <div class="tbl-cell">
                        <h4>Zip Firewall
                           <button class="btn btn-rounded pull-right" type="button" onclick="location.href = '<?php echo base_url(); ?>admin/vehicle/zipfarewall'">Add</button>
                        </h4>
                    </div>
                </div>
            </div>
...
//                        $catDetail = site_url('category/catdetail');
                        foreach ($vehicle as $key => $value) {
                            ...
                            <tr>
                                <td><?php echo ucfirst($value['zipcode']); ?></td>
